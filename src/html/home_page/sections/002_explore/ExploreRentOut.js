...
import './css/ExploreRentOut.scss'

const ExploreRentOut = (props) => {
    return (
        <>
            <div id='rentOut_DIV'>
            <svg width="42" height="45" viewBox="0 0 42 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M41 43.569H41.5V43.069V21.7441C41.5 14.7596 39.4613 9.43209 35.8392 5.85119C32.2187 2.27182 27.0792 0.5 21 0.5C14.9193 0.5 9.78007 2.29345 6.16024 5.88283C2.53908 9.47354 0.5 14.8004 0.5 21.7441V43.0562V43.5562H1H10.7541H11.2541V43.0562V30.0247H18.1879H18.6879V29.5247V26.0142V25.5142H18.1879H11.2541V21.7441C11.2541 17.9279 12.256 15.1829 13.9361 13.3947C15.6126 11.6103 18.0283 10.7104 21 10.7104C23.9717 10.7104 26.3874 11.6103 28.0639 13.3947C29.744 15.1829 30.7459 17.9279 30.7459 21.7441V43.069V43.569H31.2459H41Z" fill="#ECBAA3" stroke="black"/>
            </svg>
                <p className='p-large-white'>
                    Rent out.
                </p>
                <div id='rentOut_FOOTER'>
